...
import ProductImages from '@salesforce/resourceUrl/ALLIMAGE'; // ✅ Static Resource 가져오기
...
export default class ProductList extends LightningElement {
    ...
    wiredAccount({ error, data }) {
        if (data) {
            this.accountName += data.Name+"이 구매한 제품";
        } else if (error) {
        ...
        try {
            ...
            if (data) {
                this.products = data.map(item => ({
                    ...
                    imageUrl: "https://crm101-2a-dev-ed.develop.my.site.com/gps/s/MAVERICKVol...png"
